...
module Jenkins2
	...
	class Client
		...
		# +scope+:: Scope of the credential. GLOBAL or 
		...
		def create_credentials_username_password( **args )
			json_body = { "" => "0",
		...
		# Creates ssh username with private key credential. Accepts hash with the following parameters.
		# +scope+:: Scope of the credential. GLOBAL or 
		# +id+:: Id of the credential. Will be Generated by Jenkins, if not provided.
		# +description+:: Human readable text, what this credential is used for.
		...
		def create_credentials_ssh( **args )
			json_body = { "" => "1",
				credentials: {
					scope: args[:scope],
		...
		# Creates a secret text credential. Accepts hash with the following parameters.
		# +scope+:: Scope of the credential. GLOBAL or 
		# +id+:: Id of the credential. Will be Generated by Jenkins, if not provided.
		# +description+:: Human readable text, what this credential is used for.
		# +secret+:: Some secret text.
		def create_credentials_secret_text( **args )
			json_body = { "" => "3",
				credentials: args.merge(
		...
		# Creates a secret file credential. Accepts hash with the following parameters.
		# +scope+:: Scope of the credential. GLOBAL or 
		# +id+:: Id of the credential. Will be Generated by Jenkins, if not provided.
		# +description+:: Human readable text, what this credential is used for.
